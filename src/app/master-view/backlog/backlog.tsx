import { IgrAvatar, IgrAvatarModule, IgrButton, IgrButtonModule, IgrIconButton, IgrIconButtonModule, IgrInput, IgrInputModule, IgrList, IgrListHeader, IgrListHeaderModule, IgrListItem, IgrListModule, IgrRipple, IgrRippleModule, IgrTab, IgrTabPanel, IgrTabs, IgrTabsModule } from '@infragistics/igniteui-react';
...
export default function Backlog() {
  ...
  const [filtersVisible, setFiltersVisible] = useState<boolean | undefined>(false);
          ...
          <div className={classes("column-layout content")}>
            <div className={classes("row-layout content-toolbar")}>
              ...
              <div className={classes("row-layout group")}>
                ...
                <IgrIconButton variant="flat" clicked={() => setFiltersVisible(!filtersVisible)} className={classes("icon-button")}>
            ...
            {filtersVisible && (
              <div className={classes("row-layout filters")}>
                ...
                <div className={classes("row-layout group_2")}>
                  ...
                  <IgrIconButton variant="flat" clicked={() => setFiltersVisible(!filtersVisible)} className={classes("icon-button_1")}>
                    <span className={classes("material-icons")} key={uuid()}>
            ...
            <IgrTabs className={classes("tabs")}>
              ...
              <IgrTabPanel className={classes("column-layout tab-item-content")} key={uuid()}>
                <IgrGrid data={northwindOrders} primaryKey="employeeID" allowFiltering="true" filterMode="excelStyleFilter" className={classes("ig-typography ig-scrollbar grid")}>
                  <IgrColumn field="orderID" dataType="number" header="orderID" sortable="true" hasSummary="true" disabledSummaries={['min', 'max', 'sum', 'average']} selectable="false"></IgrColumn>
                  <IgrColumn field="customerID" dataType="string" header="customerID" sortable="true" hasSummary="true" selectable="false"></IgrColumn>
                  <IgrColumn field="employeeID" dataType="number" header="employeeID" sortable="true" hasSummary="true" disabledSummaries={['min', 'max', 'sum', 'average']} selectable="false"></IgrColumn>
                  <IgrColumn field="orderDate" dataType="date" header="orderDate" sortable="true" hasSummary="true" disabledSummaries={['earliest', 'latest']} selectable="false"></IgrColumn>
                  <IgrColumn field="requiredDate" dataType="date" header="requiredDate" sortable="true" hasSummary="true" disabledSummaries={['earliest', 'latest']} selectable="false"></IgrColumn>
                  <IgrColumn field="shippedDate" dataType="date" header="shippedDate" sortable="true" hasSummary="true" disabledSummaries={['earliest', 'latest']} selectable="false"></IgrColumn>
                  <IgrColumn field="shipVia" dataType="number" header="shipVia" sortable="true" hasSummary="true" disabledSummaries={['min', 'max', 'sum', 'average']} selectable="false"></IgrColumn>
                  <IgrColumn field="freight" dataType="number" header="freight" sortable="true" hasSummary="true" disabledSummaries={['min', 'max', 'sum', 'average']} selectable="false"></IgrColumn>
                  <IgrColumn field="shipName" dataType="string" header="shipName" sortable="true" hasSummary="true" selectable="false"></IgrColumn>
                  <IgrColumn field="shipAddress.street" dataType="string" header="street" sortable="true" hasSummary="true" selectable="false"></IgrColumn>
                  <IgrColumn field="shipAddress.city" dataType="string" header="city" sortable="true" hasSummary="true" selectable="false"></IgrColumn>
                  <IgrColumn field="shipAddress.region" dataType="string" header="region" sortable="true" hasSummary="true" selectable="false"></IgrColumn>
                  <IgrColumn field="shipAddress.postalCode" dataType="string" header="postalCode" sortable="true" hasSummary="true" selectable="false"></IgrColumn>
                  <IgrColumn field="shipAddress.country" dataType="string" header="country" sortable="true" hasSummary="true" selectable="false"></IgrColumn>
                </IgrGrid>
              </IgrTabPanel>
              ...
              <IgrTabPanel className={classes("row-layout tab-item-content")} key={uuid()}>
                <IgrGrid data={northwindCustomers} primaryKey="customerID" allowFiltering="true" filterMode="excelStyleFilter" className={classes("ig-typography ig-scrollbar grid_1")}>
                  <IgrColumn field="customerID" dataType="string" header="customerID" sortable="true" hasSummary="true" selectable="false"></IgrColumn>
                  <IgrColumn field="companyName" dataType="string" header="companyName" sortable="true" hasSummary="true" selectable="false"></IgrColumn>
                  <IgrColumn field="contactName" dataType="string" header="contactName" sortable="true" hasSummary="true" selectable="false"></IgrColumn>
                  <IgrColumn field="contactTitle" dataType="string" header="contactTitle" sortable="true" hasSummary="true" selectable="false"></IgrColumn>
              ...
              <IgrTabPanel className={classes("row-layout tab-item-content")} key={uuid()}>
                <IgrGrid data={northwindEmployees} primaryKey="employeeID" allowFiltering="true" filterMode="excelStyleFilter" className={classes("ig-typography ig-scrollbar grid_1")}>
                  ...
                  <IgrColumn field="birthDate" dataType="date" header="birthDate" sortable="true" hasSummary="true" disabledSummaries={['earliest', 'latest']} selectable="false"></IgrColumn>
                  <IgrColumn field="hireDate" dataType="date" header="hireDate" sortable="true" hasSummary="true" disabledSummaries={['earliest', 'latest']} selectable="false"></IgrColumn>
                  <IgrColumn field="address.street" dataType="string" header="address street" sortable="true" hasSummary="true" selectable="false"></IgrColumn>
                  <IgrColumn field="address.city" dataType="string" header="address city" sortable="true" hasSummary="true" selectable="false"></IgrColumn>
                  <IgrColumn field="address.region" dataType="string" header="address region" sortable="true" hasSummary="true" selectable="false"></IgrColumn>
                  <IgrColumn field="address.postalCode" dataType="string" header="address postalCode" sortable="true" hasSummary="true" selectable="false"></IgrColumn>
                  <IgrColumn field="address.country" dataType="string" header="address country" sortable="true" hasSummary="true" selectable="false"></IgrColumn>
                  <IgrColumn field="address.phone" dataType="string" header="address phone" sortable="true" hasSummary="true" selectable="false"></IgrColumn>
                  <IgrColumn field="managerID" dataType="number" header="managerID" sortable="true" hasSummary="true" disabledSummaries={['min', 'max', 'sum', 'average']} selectable="false"></IgrColumn>
              ...
              <IgrTabPanel className={classes("row-layout tab-item-content")} key={uuid()}>
                <IgrGrid data={northwindSuppliers} primaryKey="supplierID" allowFiltering="true" filterMode="excelStyleFilter" className={classes("ig-typography ig-scrollbar grid_1")}>
                  <IgrColumn field="supplierID" dataType="number" header="supplierID" sortable="true" hasSummary="true" disabledSummaries={['min', 'max', 'sum', 'average']} selectable="false"></IgrColumn>
                  <IgrColumn field="companyName" dataType="string" header="companyName" sortable="true" hasSummary="true" selectable="false"></IgrColumn>
                  <IgrColumn field="contactName" dataType="string" header="contactName" sortable="true" hasSummary="true" selectable="false"></IgrColumn>
                  <IgrColumn field="contactTitle" dataType="string" header="contactTitle" sortable="true" hasSummary="true" selectable="false"></IgrColumn>
                  <IgrColumn field="address.street" dataType="string" header="address street" sortable="true" hasSummary="true" selectable="false"></IgrColumn>
